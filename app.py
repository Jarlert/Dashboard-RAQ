...
st.markdown("""
    ...
    .cliente-item { 
        font-size: 9px; padding: 6px 10px; margin-bottom: 3px; border-radius: 4px; color: #000 !important; 
        font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; border: 1px solid rgba(0,0,0,0.1); 
    }
...
# 4. AGREGADOS ASIGNADOS (KPIs desde hoja "ASIGNADOS")
...
# 5. MOTOR RUTA POR FECHA (Desde hoja "RUTAS PRE PLANIFICADAS")
@st.cache_data(ttl=30)
